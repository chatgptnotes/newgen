...
export async function POST(request: NextRequest) {
    try {
        ...
        // Fetch recent titles from Supabase to avoid repetition
        ...
        // Pick a random seed topic to force variety
        const somedayTopics = [
        ...
        const topicPool = content_type === 'someday' ? somedayTopics : everydayTopics;
